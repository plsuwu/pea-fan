...
pub mod prelude {
    ...
    pub use crate::db::models::channel::{ChannelLeaderboardEntry, ChannelScoreSummary};
    pub use crate::db::models::chatter::{Chatter, ChatterId};
    pub use crate::db::models::chatter::{ChatterLeaderboardEntry, ChatterScoreSummary};
